...
# def extract_content(filepath,prompt):
#     if filepath.endswith(".pdf"):
#         data = PDFMinerLoader(rtf_filepath).load()
...
#     faiss_docsearch = FAISS.from_documents(texts, embeddings)
...
#         chain_type="stuff",
#         retriever=faiss_docsearch.as_retriever(),
#         chain_type_kwargs=chain_type_kwargs,
#     )
    
#     instruct = """Make sure the output should follow the Desired Format:

#         Desired Output Format: classified category along with the severity level for each category and type of risk based on severity score.
        
#         """
    
#     result = faiss_support_qa({"query": instruct})
#     similarity_score = faiss_docsearch.similarity_search_with_score(instruct)
#     print("--------------------------------")
#     percent_score = similarity_score[0][1]*100
#     # similarity_score_lst.append(percent_score)
#     print(result)
#     # dict_result = json.loads(result["result"])
#     # print(dict_result)
#     return result
